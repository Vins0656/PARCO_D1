...
SRC_MAIN="${SRC_MAIN:-parcoD1_albus.c++}"
SRC_LIB="${SRC_LIB:-parcoD1Lib.c++}"   # rimuovi se non usi la lib
EXE="${EXE:-parcoD1_albus.exe}"
...
OUTDIR="${OUTDIR:-perf_out_albus}"
BIND="${BIND:-spread}"                  # close|spread
...
SCHED_NAME="${SCHED_NAME:-albus}"  # Passato dal PBS o default
